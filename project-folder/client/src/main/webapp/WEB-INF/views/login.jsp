...
<div class="row text-light">
    ...
    <form method="POST" action="${contextPath}/login"  class="col-4 offset-4">
        <h1 class="display-5 text-light text-center">LOG IN</h1>
        ...
        <div class="form-group ${error != null ? 'has-error' : ''}">
            ...
            <button class="btn btn-lg btn-outline-light btn-block" type="submit">Log In</button>
            <a href="/registration" class="btn btn-lg btn-link btn-block text-light" >Sign in</a>
        </div>
