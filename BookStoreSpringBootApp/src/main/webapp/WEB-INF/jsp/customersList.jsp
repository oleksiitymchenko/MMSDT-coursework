                ...
                <form method="POST" action="/customers/create">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" title="surname" class="form-control" id="surname">
                        </div>
                        <div class="form-group">
                            <label for="email" class="col-form-label">Email:</label>
                            <input type="text" title="email" class="form-control" id="email">
                        </div>
                    </div>
    ...
    <table class="table table-striped table-dark">
        ...
        <c:forEach  items="${customers}" var ="client">
            <tr>
                ...
                <td>
                    <div>
                        <a type="button" class="btn btn-warning" href="/customers/${client.id}" style="margin-right: 10px">Detail</a>
                        <a type="button" class="btn btn-danger" href="/customers/delete/${client.id}" >Delete</a>
                    </div>
                </td>
            </tr>
        </c:forEach>
